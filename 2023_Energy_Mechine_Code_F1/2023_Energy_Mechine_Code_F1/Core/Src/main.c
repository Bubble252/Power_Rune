...
void state_1(void);
void state_2(void);
void light(uint32_t which,uint32_t sum);
/* USER CODE END PTD */
...
//		WS_Write_RGB_ALL_RING(0,0,225);
//		WS_WriteAll_RGB_FRAME_DOWN(0,0,255);
//		WS_WriteAll_RGB_FRAME_UP(0,0,255);
//      WS_WriteAll_RGB_FRAME(0,0,255);
//  		LED_Blue_rectangle_current(10000,0,0,255);
...
//		WS_WriteAll_RGB_FRAME_DOWN(0,0,255);
//		WS_WriteAll_RGB_FRAME_UP(0,0,255);	
//  	LED_Blue_rectangle_current(20000,0,0,255);
////		
////			WS_WriteAll_RGB_REC(0,0,150);
////			WS_WriteAll_RGB_FRAME(0,0,150);
//			WS_CloseAll_Circle();
//			WS_Write_RGB_THREE_RING(0,0,255);
//		HAL_Delay(20000000);
////		
////		WS_Write_RGB_ALL_RING(0,0,225);
...
//		WS_Write_RGB_ALL_RING(0,0,225);
    ...
    /* USER CODE BEGIN 3 */
		 ...
		 /**************************************测试代码***************************************/
		/***************微动开关测试*********************/
//Big_Fu_info[BOARD_NUMBER].Hit_LED_state = HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7); 
//		if(HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_4)&&HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_5)&&HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_6)&&HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_7))
//			if(HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_6))
////				if(HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_0)&&HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_1)&&HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_2)&&HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_3))
//		{
...
void light(uint32_t which,uint32_t sum)
{
//	HAL_Delay((which-1)*6500);
//	state_1();
//	HAL_Delay(2500);
//	state_2();
//	HAL_Delay(4000);
//	HAL_Delay((sum-1)*6500-(which-1)*6500);
	...
	state_2();
//	HAL_Delay(4000);
	HAL_Delay((sum-1)*2500-(which-1)*2500);
}
/* USER CODE END 4 */
